 ...
 */
final class Version20240826092319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agriculteurs DROP roles');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agriculteurs ADD roles JSON NOT NULL');
